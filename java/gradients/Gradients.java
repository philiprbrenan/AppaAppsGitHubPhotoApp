...
public class Gradients                                                          //C Gradients in various patterns
 {final private ColoursTransformed ct = new ColoursTransformed();               // Colour transformer
  ...
  public White white()                                                          //M A new white paint
   {return new White();
   }

  public Black black()                                                          //M A new black paint
   {return new Black();
   }
  ...
  public class Tartan                                                           //C Create a tartan paint gradient
   ...
   {private final Fourier                                                       // Corners, orientation
    ...
    public Tartan make()                                                        //O=com.appappps.Gradients.Pattern.make Make a new instance of this pattern thus providing variation within a common theme
     {return new Tartan(speed);
     }
  ...
  public class Chess                                                            //C Create a chess board pattern in black and white
   ...
   {private Chess                                                               //C Create a chess board paint gradient
    ...
    public Chess make()                                                         //O=com.appappps.Gradients.Pattern.make Make a new instance of this pattern thus providing variation within a common theme
     {return new Chess(speed);
     }
  ...
  public class White                                                            //C Plain white
    extends Pattern
   {public void set                                                             //O=com.appaapps.Gradients.set Set the two paints needed to draw the tartan gradient
     (Canvas canvas,                                                            //P Canvas so that we can get the size of the drawing area
      final float w,                                                            //P Approximate width in pixels of the thing to be drawn
    ...
    public White make()                                                         //O=com.appappps.Gradients.Pattern.make Make a new instance of this pattern thus providing variation within a common theme
     {return new White();
     }
    public String name()                                                        //O=com.appappps.Gradients.Pattern.name Name of the pattern
     {return "White";
  ...
  public class Black                                                            //C Plain black
    extends Pattern
   {public void set                                                             //O=com.appaapps.Gradients.set Set the two paints needed to draw the tartan gradient
     (Canvas canvas,                                                            //P Canvas so that we can get the size of the drawing area
      final float w,                                                            //P Approximate width in pixels of the thing to be drawn
     ...
     {p.setAntiAlias(true);
      p.setDither(true);
      p.setColor(0xff00000);
      q.setAntiAlias(true);
      q.setDither(true);
      q.setColor(0xff000000);
     }
    public Black make()                                                         //O=com.appappps.Gradients.Pattern.make Make a new instance of this pattern thus providing variation within a common theme
     {return new Black();
     }
    public String name()                                                        //O=com.appappps.Gradients.Pattern.name Name of the pattern
     {return "Black";
